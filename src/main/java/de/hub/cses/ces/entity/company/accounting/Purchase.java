 ...
 */
@Entity
@Table(name = "accounting_balance_transaction_product_purchase_tbl")
...
public class Purchase extends ProductTransaction {
     ...
     * @param quantity
     */
    public Purchase(double amountPosted, Date posted, Balance balance, Product product, double pricePerUnit, int quantity) {
