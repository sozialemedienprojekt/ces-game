 ...
 */
@Entity
@Table(name = "company_tbl", uniqueConstraints
        = @UniqueConstraint(columnNames = {"identifier", "economy"}))
@NamedQuery(name = "Company.findByIdentifierAndEconomy", query = "SELECT c FROM Company c WHERE c.identifier = :identifier AND c.economy = :economy")
