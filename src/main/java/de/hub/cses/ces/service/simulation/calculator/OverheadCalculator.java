...
import de.hub.cses.ces.entity.company.accounting.Overhead;
...
@Named
@RequestScoped
public class OverheadCalculator extends CompanyCalculator {
    ...
    public void calculate(Company company, Date current) throws NullPointerException {
        double overhead = company.getFactory().getOverhead();
        balanceTransactionAccounting.account(company.getBalance(), -overhead, current, Overhead.class);
    }
