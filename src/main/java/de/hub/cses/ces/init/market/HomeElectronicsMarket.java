...
/**
 *
 * an example of market data, representing a market for home electronics
 *
 * @author Sebastian Gross <sebastian.gross@hu-berlin.de>
 */
public final class HomeElectronicsMarket {
    ...
    private static final Factory[] factories = {
        ...
        new Factory(1L, 150000, 10000d, 0.7, 80, 120, factoryDescriptions[0]),
        // define medium factory
        new Factory(2L, 250000, 15000d, 1.0, 120, 200, factoryDescriptions[1]),
        // define large factory
        new Factory(3L, 350000, 20000d, 1.3, 160, 280, factoryDescriptions[2])
    };
    // </editor-fold>
    ...
    private static final I18nText[] sectorDescriptions = {
        ...
        new I18nText(19L, new HashMap<SupportedLanguage, String>() {
            {
                put(SupportedLanguage.DEUTSCH, "Marktsektor für Mobilfunkgeräte");
