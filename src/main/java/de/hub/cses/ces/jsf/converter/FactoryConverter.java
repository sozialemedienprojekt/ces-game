...
public final class FactoryConverter extends AbstractEntityConverter<Factory> {
     ...
     */
    @Override
    public Collection<Factory> getEntities() {
        return gameSetup.getSector().getFactories();
    }
}
